                ...
                <table class="min-w-full divide-y divide-gray-200 text-sm">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="whitespace-nowrap px-4 py-3 text-left font-medium text-gray-600">Issued By</th>
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        >
                            ...
                            <td class="whitespace-nowrap px-4 py-3 text-gray-700">{{ b.borrower_name }}</td>
                            <td class="whitespace-nowrap px-4 py-3 text-gray-600">{{ fmtDate(b.borrowed_date) }}</td>
                            <td class="whitespace-nowrap px-4 py-3 text-gray-600" :class="{ 'text-red-600 font-medium': isOverdue(b.due_date, b.returned_date) }">
                                {{ fmtDate(b.due_date) }}
                            </td>
                            ...
                            <td class="whitespace-nowrap px-4 py-3 text-gray-600 text-xs">{{ b.issued_by?.name }}</td>
